...
<head>
    <meta charset="utf-8">
    <meta name="description" content="Distributor Bahan Bangunan | Gypsum | Besi Beton | Baja Ringan | Bata Ringan | Semen ">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- <meta name="viewport" content="width=1100"> -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <!-- Bootstrap CSS -->
    <title>Galactica Jaya Raya - Distributor Bahan Bangunan</title>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo site_url('/pricelist') ?>">Pricelist</a>
                        </li>
                        <li class="nav-item">
